    ...
    <KeyboardAvoidingView style={styles.screen} behavior="padding" keyboardVerticalOffset={0}>
      ...
      <FlatList
        ...
        contentContainerStyle={[styles.messages, { paddingBottom: listBottomPadding }]}
         ListHeaderComponent={sending ? <View style={styles.typingRow}><View style={styles.typingBubble}><ActivityIndicator size="small" color={colors.primary} /><Text style={styles.typingText}>نغمه در حال آماده‌کردن پاسخ است…</Text></View></View> : null}
      />
      ...
      <View style={[styles.composerArea, { paddingBottom: composerBottomPadding }]}>
        <View style={styles.composer}>
         ...
         <Text style={styles.privacyHint}>پیام‌ها برای پاسخ‌گویی به Gemini ارسال می‌شوند.</Text>
      </View>
